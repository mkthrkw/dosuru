...
-- CreateIndex
CREATE INDEX "Ticket_listId_idx" ON "Ticket"("listId");
...
-- AddForeignKey
ALTER TABLE "Ticket" ADD CONSTRAINT "Ticket_listId_fkey" FOREIGN KEY ("listId") REFERENCES "List"("id") ON DELETE CASCADE ON UPDATE CASCADE;
